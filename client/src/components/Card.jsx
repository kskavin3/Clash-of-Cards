...
const img1 = allCards[17];
const img2 = allCards[18];

const Card = ({ card, title, restStyles, cardRef, playerTwo, imgUrl }) => (
  <div>
  <Tilt>
    <div ref={cardRef} className={`${styles.cardContainer} ${restStyles}`}>
      <img src={playerTwo ? img2 : img1} alt="ace_card" onClick={() => window.open("https://testnets.opensea.io/assets/mumbai/0xe9e137e7a7962c03abe61958336fd5441e25f81b/7")} className={styles.cardImg} />
